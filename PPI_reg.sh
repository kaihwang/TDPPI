...
for s in 106; do
	...
	-stim_file 10 ${WD}/${s}/PRE/PPI/Reg_motion.1D[3] -stim_label 10 motpar4 -stim_base 10 \
	-stim_file 11 ${WD}/${s}/PRE/PPI/Reg_motion.1D[4] -stim_label 11 motpar5 -stim_base 11 \
	-stim_file 12 ${WD}/${s}/PRE/PPI/Reg_motion.1D[5] -stim_label 12 motpar6 -stim_base 12 \
	-gltsym 'SYM: +1*irrelevant' -glt_label 1 gPPI_irrelevant \
	-gltsym 'SYM: +1*relevant' -glt_label 2 gPPI_relevant \
	-gltsym 'SYM: +1*irrelevant -1*relevant' -glt_label 3 gPPI_irrelevant-relevant \
	-gltsym 'SYM: +1*stimtime_irrelevant' -glt_label 4 stimtime_irrelevant \
