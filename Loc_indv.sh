...
for s in $(ls -d *); do
	...
	3dcalc -a face_v_house_tstat+tlrc -b /home/despoB/kaihwang/TRSE/TRSEPPI/Group/Group_FFA_mask.nii.gz \
	...
	3dcalc -a face_v_house_tstat+tlrc -b /home/despoB/kaihwang/TRSE/TRSEPPI/Group/Group_PPA_mask.nii.gz \
